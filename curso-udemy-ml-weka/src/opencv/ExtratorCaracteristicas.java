...
public class ExtratorCaracteristicas {
	...
	exportacao += "@data\n";
        ...
        // Diretorio onde estao armazenadas as imagens
        ...
        for (int i = 0; i < arquivos.length; i++) {
            ...
            for (int altura = 0; altura < imagemProcessada.height(); altura++) {
                for (int largura = 0; largura < imagemProcessada.width(); largura++) {
                    ...
                    // Extracao do RGB de cada pixel da imagem
                    ...
                    // Calca azul do Bart (metade de baixo da imagem)
            ...
            // Imagem processada de acordo com as caracteristicas (alteracao das cores)
            imagemProcessada = new IplImage(mtx);

            // Normaliza as caracterÃ­sticas pelo numero de pixels totais da imagem
            ...
            // Grava as caracteristicas no vetor de caracteristicas
            ...
            System.out.println("Laranja camisa Bart: " + caracteristicas[i][0] + " - Azul calça Bart: " + caracteristicas[i][1] + " - Azul sapato Bart: " + caracteristicas[i][2] + " - Azul calça Homer: " + caracteristicas[i][3] + " - Marrom boca Homer: " + caracteristicas[i][4] + " - Preto sapato Homer: " + caracteristicas[i][5] + " - Classe: " + caracteristicas[i][6]);
