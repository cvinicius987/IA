...
public class ExtratorCaracteristicas {
	...
	exportacao += "@data\n";
        ...
        for (int i = 0; i < arquivos.length; i++) {
            ...
            // Normaliza as características pelo numero de pixels totais da imagem
            ...
            System.out.println("Laranja camisa Bart: " + caracteristicas[i][0] + " - Azul cal�a Bart: " + caracteristicas[i][1] + " - Azul sapato Bart: " + caracteristicas[i][2] + " - Azul cal�a Homer: " + caracteristicas[i][3] + " - Marrom boca Homer: " + caracteristicas[i][4] + " - Preto sapato Homer: " + caracteristicas[i][5] + " - Classe: " + caracteristicas[i][6]);
